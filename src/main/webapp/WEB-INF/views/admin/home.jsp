        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <%-- begin search --%>
                        <c:set var="buildingListURL" value="/home"/>
                                ...
                                <div class="widget-main">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-12 col-sm-4">
                                                <div>
                                                    ...
                                                    <select id="district" name="district" onchange="">
                                            ...
                                            <div class="col-xs-12 col-sm-4">
                                                <div>
                                                    <label for="name">Phường</label> <input
                                                        type="text" id="" name="ward" class="form-control"
                                                        value="${model.ward}"/>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4">
                                                <div>
                                                    <label for="name">Đường</label> <input
                                                        type="text" id="" name="street" class="form-control"
                                                        value="${model.street}"/>
                                                </div>
                                            </div>
                                            <!-- PAGE CONTENT ENDS -->
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-12 col-sm-4">
                                                <div>
                                                    <label for="name">Hướng</label> <input type="text"
                                                                                                   id="" name=""
                                                                                                   class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4">
                                                <div>
                                                    <label for="name">Hạng</label> <input type="text"
                                                                                                  id="" name=""
                                                                                                  class="form-control"/>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-12 col-sm-3">
                                                <div>
                                                    <label for="name">Diện tích đến</label> <input
                                            ...
                                            <div class="col-xs-12 col-sm-3">
                                                <div>
                                                    <label for="name">Giá thuê từ</label> <input
                                            ...
                                            <div class="col-xs-12 col-sm-3">
                                                <div>
                                                    <label for="name">Giá thuê đến</label> <input
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-12 col-sm-4">
                                                <div>
                                                    <label for="">Điện thoại quản lý</label> <input
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="col-xs-12 col-sm-4">
                                                <button type="submit" class="btn btn-success" id="btnSearchBuilding">Tìm
                                                    kiếm
                                                </button>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="pull-right">
                            <a href="<c:url value="/edit"/>" class="btn btn-white btn-info btn-bold"
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <table id="buildingList"
                            ...
                            <tbody>
                            <c:forEach var="x" items="${buildings}">
                                <tr>
                                    <td><input type="checkbox" value="${x.id}" id="check_1"/></td>
                                    <td>${x.name}</td>
                                    <td>${x.ward}</td>
                                    <td>${x.street}</td>
                                    <td>abc</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default"
                        id="btnAssignBuilding">Giao tòa nhà
                </button>
